...
int main(int argc, char **argv){
	...
	if (read_snapshot(Snapshot, format, LUNIT, MUNIT, SWP, LGADGET, DGADGET,Nlin,nthreads,&x, &y, &z, NULL, NULL, NULL, &Npart, &mpart, &Lbox, &om_m,&ListOfParticles,&NPartPerCell,&dens)==0)
